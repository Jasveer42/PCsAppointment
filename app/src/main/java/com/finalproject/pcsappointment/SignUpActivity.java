...
public class SignUpActivity extends AppCompatActivity {
    ...
    private EditText etUserId, etFirstName, etLastName, etPassword, etConfirmPassword, etEmail, etPhone;
            ...
            public void onClick(View view) {
                ...
                if (!password.equals(confirmPassword)) {
                    ...
                    if (PrefManager.isNetworkAvailable(SignUpActivity.this))
                        RegisterUserRequest(userId, firstName, lastName, email, phone, userType, password);
                    else
    ...
    private void RegisterUserRequest(String userId, String firstName, String lastName, String email, String phone, String userType, String password) {
        String url = API.REGISTRATION_URL + userId + "&" + email + "&" + firstName + "&" + lastName + "&" + password + "&" + phone + "&" + userType;
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(SignUpActivity.this, "Error While Registering User", Toast.LENGTH_SHORT).show();
                        }
                    }
