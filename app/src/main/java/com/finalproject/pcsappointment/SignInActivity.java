                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            if (response.getString("Status").equalsIgnoreCase(API.STATUS_OK)) {
                                ...
                                PrefManager.savePreference(SignInActivity.this, PrefManager.LOGIN_ID, response.getString("UserID"));
                                PrefManager.savePreference(SignInActivity.this, PrefManager.USER_NAME, response.getString("FirstName"));
